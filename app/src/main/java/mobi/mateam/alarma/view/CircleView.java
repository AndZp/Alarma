...
public class CircleView extends View {
   ...
   */
  public final static Property<CircleView, Integer> FILL_COLOR = new Property<CircleView, Integer>(Integer.class, "fillColor") {
    @Override public Integer get(CircleView view) {
      return view.getFillColor();
    }

    @Override public void set(CircleView view, Integer value) {
   ...
   */
  public final static Property<CircleView, Float> RADIUS = new Property<CircleView, Float>(Float.class, "radius") {
    @Override public Float get(CircleView view) {
      return view.getRadius();
    }

    @Override public void set(CircleView view, Float value) {
  ...
  private void invalidate(float centerX, float centerY, float radius) {
    invalidate((int) (centerX - radius - 0.5f), (int) (centerY - radius - 0.5f), (int) (centerX + radius + 0.5f), (int) (centerY + radius + 0.5f));
  }
   ...
   */
  @SuppressLint("RtlHardcoded") private void applyGravity(int gravity, int layoutDirection) {
