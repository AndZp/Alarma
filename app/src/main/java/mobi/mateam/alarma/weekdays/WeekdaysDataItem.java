...
public class WeekdaysDataItem implements Parcelable {
  ...
  public String getLetters() {
    if (numberOfLetters >= label.length()) numberOfLetters = label.length();
  ...
  public WeekdaysDataItem(int position, int calendarId, String label, Drawable drawable, int textDrawableType, int numberOfLetters,
      boolean selected) {
    this.position = position;
    this.label = label;
    this.drawable = drawable;
  ...
  public static final Creator<WeekdaysDataItem> CREATOR = new Creator<WeekdaysDataItem>() {
